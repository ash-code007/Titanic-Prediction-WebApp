...
def main():
    ...
    sibsp =st.number_input('# of siblings / spouses aboard:', min_value=0, max_value=10,step=1)
    
    parch =st.number_input('# of parents / children aboard:', min_value=0, max_value=10,step=1)
